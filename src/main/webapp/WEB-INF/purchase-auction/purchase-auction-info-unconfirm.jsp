...
<div id="wrapper">
    ...
    <div id="main" style="padding: 0em 0 2em 0;">
        <div class="inner">
            ...
            &nbsp 판매권입찰 ㆍ ${purchaseAuction.purchaseAuction.productCategory.toKorean} ㆍ ${purchaseAuction.purchaseAuction.deadline.toString().substring(0,10)} ${purchaseAuction.purchaseAuction.deadline.toString().substring(11,16)}
