          ...
          <form action="/sign-cp" method="post">
             <table>
                 <tr style="background-color: #FFF;border: 0;">
                    <td>
                       <span>
                          <input type="text" id="userName" name = "userName" class="input-text" placeholder="NAME" maxlength="15" onfocusout="validateName()">
                       </span>
                ...
                <tr style="background-color: #FFF;border: 0;">
                   <td>
                      <span>
                         <input type="text" name = "userEmail" id="userEmail" class="input-text" placeholder="EMAIL" maxlength="20" onfocusout="validateId()">
                      </span>
                ...
                <tr style="background-color: #FFF;border: 0;">
                   <td>
                      <span>
                         <input type="password" name = "pwd" id="pwd" class="input-text" placeholder="PW" maxlength="20" onfocusout="validatePassword()">
                      </span>
                ...
                <tr style="background-color: #FFF;border: 0;">
                   <td>
                      <span>
                         <input type="password" id="pwdChk" class="input-text" placeholder="PW CHECK" maxlength="20" onfocusout="validatePassword()">
                      </span>
